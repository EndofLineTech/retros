...
- **Phase 2 (automation + conveniences):** opt-in auto-run (default off), dummy-EPG auto-assignment, a confirmed/journaled guided auto-sync toggle, and an ambiguous-band review queue keyed on content fingerprints.
